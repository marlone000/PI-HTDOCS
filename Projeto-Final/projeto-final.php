    ...
    <header class="cabecalho">
        <nav>
          ...
          <ul class="nav-list ">
            ...
            <li><a href="/P.I/sobre/sobre.php">Sobre</a></li>
          </ul>
        </nav>
      </header>
...
<div id="footer_content" class="footer-letter">
    ...
    <ul class="footer-list">
        ...
        <li>
            <a href="/P.I/Projeto-Final/projeto-final.php" class="footer-link">Animes</a>
        </li>
    </ul>
    <ul class="footer-list">
        <li>
        ...
        <li>
            <a href="/P.I/sobre/sobre.php" class="footer-link">Quem Somos</a>
        </li>
